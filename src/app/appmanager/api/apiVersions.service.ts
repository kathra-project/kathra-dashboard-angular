...
export class ApiVersionsService {
    ...
    public createApiVersion(componentId: string, openApiFile?: Blob, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (openApiFile !== undefined) {
            formParams.append('openApiFile', <any>openApiFile);
        }
     ...
     * 
     * @param apiVersionId The ID of the Component the APIVersion will be deleted for
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public deleteApiVersion(apiVersionId: string, observe?: 'body', reportProgress?: boolean): Observable<ApiVersion>;
    public deleteApiVersion(apiVersionId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ApiVersion>>;
    public deleteApiVersion(apiVersionId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ApiVersion>>;
    public deleteApiVersion(apiVersionId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (apiVersionId === null || apiVersionId === undefined) {
            throw new Error('Required parameter apiVersionId was null or undefined when calling deleteApiVersion.');
        }
        ...
        return this.httpClient.delete<ApiVersion>(`${this.basePath}/apiVersions/${encodeURIComponent(String(apiVersionId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
